...
public class XMLName
{
   ...
   public static XMLName create(String uri, String localName, String prefix)
   {
      ...
      // Get the qualified and universal names. This also checks if the names are legal.
      // Note that the qualified name is not set if the URI is non-null and the prefix is null.
